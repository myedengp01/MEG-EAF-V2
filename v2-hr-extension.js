...
V2.version='MEG-EAF-HR V2 v2026.09.01-15:00';
V2.jd=null;
...
function v2ApplyLoecReadOnly(){
  ...
  panel.querySelectorAll('input,select,textarea,button').forEach(function(el){el.disabled=true;});
  ...
  var acts=panel.querySelector('.v2-actions');if(acts)acts.style.display='none';
  var m=byId('v2LoecMessage');
  if(m && V2.loecRecord){m.style.display='block';m.className='v2-ok';m.innerHTML='<strong>View only.</strong> LOEC record details are visible below; all record changes, uploads, verification and revisions are disabled.';}
}
