...
V2.version='MEG-EAF-HR V2 v2026.08.31-22:15';
V2.jd=null;
...
function renderHrApplicantPosts(){
  ...
  if(V2.jd&&eid){
    ...
    families=(V2.jd.departments||[]).filter(function(d){return d.entity_id===eid&&deptIds[String(d.id)]&&d.is_active!==false;}).slice().sort(function(a,b){
